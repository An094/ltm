...
//PURPOSE: take user, pass and send to server
...
//FUNCTION: login(SOCKET)
//PURPOSE: send message with header LOGOUT to server and receive message
...
//FUNCTION: login(SOCKET)
//PURPOSE: send message with header EXIT to server and receive message. 
...
//PURPOSE: receive() wrapper function
